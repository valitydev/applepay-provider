...
/**
 * An OkHttp interceptor which logs request and response information. Can be applied as an {@linkplain
 * OkHttpClient#interceptors() application interceptor} or as a {@linkplain OkHttpClient#networkInterceptors() network
 * interceptor}. <p> The format of the logs created by this class should not be considered stable and may change
