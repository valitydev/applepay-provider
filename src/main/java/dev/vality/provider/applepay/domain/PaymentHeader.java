...
public class PaymentHeader {
    ...
    @JsonCreator
    public PaymentHeader(@JsonProperty(value = "applicationData") String applicationData,
    ...
    public String toString() {
        return "PaymentHeader{" + "applicationData='" + applicationData + '\'' + ", ephemeralPublicKey='"
               + ephemeralPublicKey + '\'' + ", wrappedKey='" + wrappedKey + '\'' + ", publicKeyHash='" + publicKeyHash
