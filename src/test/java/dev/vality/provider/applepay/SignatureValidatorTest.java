...
import dev.vality.provider.applepay.domain.Auth3DS;
import dev.vality.provider.applepay.domain.PaymentData;
import dev.vality.provider.applepay.domain.PaymentDataKeys;
...
public class SignatureValidatorTest {
    ...
    public void testValidation() throws Exception {
        ...
        new SignatureValidator(
                ...
                -1).validate(paymentData.getHeader(), paymentData.getData(), paymentData.getSignature(),
                paymentData.getVersion());
    }


    private static PaymentData createPaymentData(String name) throws IOException {
        return new ObjectMapper().readValue(SignatureValidatorTest.class.getClassLoader().getResourceAsStream(name),
                PaymentData.class);
    }
